...
#       SELECT
#           board.no AS board_no,
#           board.writer AS board_writer,
#           board.title AS board_title,
#           board.content AS board_content,
#           board.date AS board_date,
#           board.del_yn AS board_del_yn
#       FROM board
        post = db.query(Board).filter(and_(
            Board.no == post_no,
            Board.del_yn == "Y"
            )).first()
        print(post)
